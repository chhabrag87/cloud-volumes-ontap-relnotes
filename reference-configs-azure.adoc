...
. SN only supports LRS managed disks for Standard SSD and HDD and Premium SSD.
...
. Redundancy options for HA configurations include Non-zonal HA pair using Premium LRS pageblob, Non-zonal VM HA pair using Premium LRS managed disk, and Multi-AZ VM HA pair using Premium ZRS managed disks.

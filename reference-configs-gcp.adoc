...
. Starting with Cloud Volumes ONTAP software version 9.13.0, _Flash cache_, high write mode, and a higher maximum transmission unit (MTU) of 8,896 bytes, are available for the following instances: 
* n2-standard-16
* n2-standard-32
* n2-standard-48
* n2-standard-64

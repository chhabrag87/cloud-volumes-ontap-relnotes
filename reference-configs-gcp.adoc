...
. Starting with Cloud Volumes ONTAP software version 9.13.0, _Flash cache_, low durability mode (LDM), and Jumbo Frames (8896 Maximum transmission unit), are available for the following instances by default: 
* n2-standard-16
* n2-standard-32
* n2-standard-48
* n2-standard-64
+ 
NOTE: _Flash cache_, LDM, and Jumbo Frames are feature-dependent and cannot be disabled individually within a configured instance. 

...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-ha-google-cloud.html[Learn how storage works in a Cloud Volumes ONTAP HA pair running in Google Cloud^].
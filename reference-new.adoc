...
=== Flash Cache and high write mode for Google Cloud
Support for flash cache, high write mode, and Jumbo Frames is now available for select instances with the Cloud Volumes ONTAP 9.13.0 release. For more information on compatibility with these latest features, see link:https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-gcp.html[Supported configurations by license for Google Cloud^].

=== Image verification for Azure and Google Cloud
Enhanced security features are now available for verifying image signatures through Azure and Google Cloud. For more information on these security features, see link:https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-azure-image-verification.html[Azure Image Verification and Google Cloud Image Verification^].

=== New instances support for Google Cloud
Freemium, PAYGO Premium, node-based BYOL, and capacity-based licenses now support two new instance types for Cloud Volumes ONTAP single node and high-availability deployments with Google Cloud. 

* n2-standard-48
* n2-standard-64

link:https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-gcp.html[Learn more about supported configurations for Google Cloud^]. 

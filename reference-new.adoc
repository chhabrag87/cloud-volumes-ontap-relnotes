...
You can upgrade to Cloud Volumes ONTAP 9.12.1 from the 9.11.1 release. BlueXP will prompt you to upgrade eligible Cloud Volumes ONTAP systems to this release.

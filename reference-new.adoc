...
The Cloud Manager Connector must be running version 3.9.16 or later to deploy new Cloud Volumes ONTAP 9.11.0 systems and to upgrade existing systems to 9.11.0.

...
Support for Flash Cache, high write speed, and jumbo frames is now available for select instances with the Cloud Volumes ONTAP 9.13.0 release. For more information on compatibility with these latest features, see link:https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-gcp.html[Supported configurations by license for Google Cloud^].

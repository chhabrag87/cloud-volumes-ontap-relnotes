...
== 9.13.1 RC1 (5 June 2023)
The Release Candidate 1 release of Cloud Volumes ONTAP 9.13.1 is now available in AWS, Azure, and Google Cloud. This release includes the following new features and enhancements.

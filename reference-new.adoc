...
The 9.11.1 P3 patch is now available for Cloud Volumes ONTAP for all cloud providers if you have a Connector running version 3.9.22 or later. Cloud Manager will prompt you to upgrade your existing systems to this patch release.

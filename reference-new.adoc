...
You can upgrade to Cloud Volumes ONTAP 9.12.1 from the 9.12.0 release and from the 9.11.1 release. BlueXP will prompt you to upgrade eligible Cloud Volumes ONTAP systems to this release.

=== Required version of the Connector

The BlueXP Connector must be running version 3.9.23 or later to deploy new Cloud Volumes ONTAP 9.12.1 systems and to upgrade existing systems to 9.12.1.

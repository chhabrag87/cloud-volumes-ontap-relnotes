...
=== ZRS Shared HA in multiple availability zones

ZRS is a Cloud Volumes ONTAP HA pair configuration that uses managed disks as backend storage and runs in multiple Azure availability zones.

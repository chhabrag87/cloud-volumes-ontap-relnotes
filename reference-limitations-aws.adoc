...
* Compression must be disabled on all volumes to take advantage of the Flash Cache performance improvements up to ONTAP 9.12.0. When you deploy or upgrade to ONTAP 9.12.1, you don't need to disable compression.
+

...
https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html[Learn how to use BlueXP backup and recovery to back up and restore ONTAP data^].
